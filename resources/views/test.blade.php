      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Bienvenue sur <span>BuildMaster</span></h2>
            <p data-aos="fade-up">Entrepreneur, architectes, ingénieur ou un particulier, 
              BuildMaster vous offre les fonctionnaltés essentielles pour gérer efficacement
          ...
          <div class="col-lg-5" data-aos="fade">
            <form action="forms/quote.php" method="post" class="php-email-form">
              ...
              <div class="row gy-3">
               ...
               <p>Vous n'avez pas un compte, <a href="sinscrire.html">S'inscrire</a>.</p>
      ...
      <h3> Connexion</h3>
              ...
              <div class="row gy-3">
                ...
                <form id="roleForm" method="POST">
                  ...
                  <label for="gestionnaire">Entreprise</label><br>
