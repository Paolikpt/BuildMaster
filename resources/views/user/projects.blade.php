            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Bonjour Amina</h3>
                  <h6 class="font-weight-normal mb-0">Je vous souhaite une bonne journée ! <span class="text-primary">3 unread alerts!</span></h6>
                </div>
