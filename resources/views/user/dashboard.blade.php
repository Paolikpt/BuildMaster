        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Bienvenue dans le dashboard client ! </h6>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 grid-margin transparent">
              <div class="row">
                <div class="mx-auto text-center col-md-8 mb-2  stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body py-5">
                      <p class="mb-4">Projets soumis</p>
                      <p class="fs-30 mb-2">{{ $submitsCount }}</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class=" text-center mx-auto col-md-8 mb-4  stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body py-5">
                      <p class="mb-4">Projets validés par un Gestionnaire</p>
                      <p class="fs-30 mb-2">{{ $validated }}</p>
                      <p>Taux de validation : {{ ($validated/$submitsCount)*100 }} %</p>
